class ThrowHandler {
    public static flip(elem: HTMLElement, direc: direction, parentElem?: HTMLElement, angle?: number): number { // ODD? HACKY?
    ...
    public static determineDirectionForFlip(vectorMove: vectorMoveObj) {
    ...
    private static throwArc(elem: HTMLElement, direc: direction) { // Handles the arc travelled NOT rotation, see CSS
        var currentLeft = parseInt(elem.style.left) || 0;
        var currentTop = parseInt(elem.style.top) || 0;
